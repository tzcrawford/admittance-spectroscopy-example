...
###Output Options
set output "ct2.png"                          ###sets output file and extension
#set output "a.jpg"
#set output "a.svg"
...
###Your Plots Here 
#we do cat abuse in this house
#don't use parens "(" in grep regex, or use escape char
C1(x)=`grep -P "^10000.0:  C"   $logfile | sed "s/10000.0:  C(x) = //g"`
C2(x)=`grep -P "^13894.955:  C" $logfile | sed "s/13894.955:  C(x) = //g"`
C4(x)=`grep -P "^19306.977:  C" $logfile | sed "s/19306.977:  C(x) = //g"`
C5(x)=`grep -P "^26826.958:  C" $logfile | sed "s/26826.958:  C(x) = //g"`
C6(x)=`grep -P "^37275.937:  C" $logfile | sed "s/37275.937:  C(x) = //g"`
C7(x)=`grep -P "^51794.747:  C" $logfile | sed "s/51794.747:  C(x) = //g"`
C8(x)=`grep -P "^71968.567:  C" $logfile | sed "s/71968.567:  C(x) = //g"`
...
C1(x) w l ls 99 lw 2 notitle, \
C2(x) w l ls 2 lw 2 notitle, \
C4(x) w l ls 4 lw 2 notitle, \
C5(x) w l ls 5 lw 2 notitle, \
C6(x) w l ls 6 lw 2 notitle, \
C7(x) w l ls 7 lw 2 notitle, \
C8(x) w l ls 8 lw 2 notitle, \
C9(x) w l ls 9 lw 2 notitle
